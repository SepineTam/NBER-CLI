...
describe('useNativeMenu', () => {
  ...
  it.each([
    ...
    const { unmount } = renderHook(() => useNativeMenu({
      openFeed,
      openSearch,
      openSettings,
      refreshFeed,
    ...
    expect({ openFeed, openSearch, openSettings, refreshFeed }[handlerName]).toHaveBeenCalledOnce()
    unmount()
    expect(stopListening).toHaveBeenCalledTimes(4)
  })
